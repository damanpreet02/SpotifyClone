...
songItems.forEach((element, i) => {
    ...
    audio.addEventListener('loadedmetadata', () => {
        ...
        // Find the .time span and update its content
        element.querySelector('.time').innerText = timeString;
    });

    // Set cover image and name as before
    element.querySelector("img.cover").src = songs[i].coverPath;
...
audioElement.addEventListener('timeupdate', () => {
    ...
    document.getElementById('currentTime').innerText = `${current} / ${total}`;
});
